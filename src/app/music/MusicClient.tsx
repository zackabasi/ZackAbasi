...
export default function MusicClient({ releases }: { releases: any[] }) {
  const { currentTrack, isPlaying, playTrack, togglePlayPause } = useAudio();
  const [openRelease, setOpenRelease] = useState<string | null>(releases.length > 0 ? releases[0].id : null);
            ...
            >
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
                  <img src={release.coverUrl || '/logo.png'} alt={release.title} style={{ width: '80px', height: '80px', borderRadius: '8px', objectFit: 'cover', boxShadow: '0 4px 12px rgba(0,0,0,0.5)' }} />
                  <div>
                ...
                {isOpen && release.tracks && (
                  ...
                  >
                    <div style={{ padding: '0 1.5rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                      ...
                      {release.tracks.map((track: any, trackIdx: number) => {
